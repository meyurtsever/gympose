"""
Phase 2: XGBoost Average Performance Evaluation (6-Class Dataset)

This script trains the XGBoost model 5 times with different random seeds
...
- Saves results to xgboost_6class_5run_results/ folder
...
def save_model_summary(results_dir, num_features, num_classes):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("XGBOOST MODEL ARCHITECTURE SUMMARY (6-CLASS)\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("XGBOOST AVERAGE PERFORMANCE EVALUATION (6-CLASS)")
    print("=" * 80)
    ...
    results_dir = Path("results/xgboost_6class_5run_results")
