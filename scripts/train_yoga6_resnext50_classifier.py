"""
Phase 3: ResNeXt50 Average Performance Evaluation (6-Class Dataset)
...
- Saves results to resnext50_6class_5run_results/ folder
...
def save_model_summary(results_dir, model, num_features, num_classes):
    ...
    summary_file = results_dir / 'resnext50_model_summary.txt'
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("RESNEXT50 MODEL ARCHITECTURE SUMMARY (6-CLASS)\n")
        f.write("=" * 80 + "\n\n")
        
        f.write("Model Type: ResNeXt50 Keypoint Classifier\n")
        ...
        f.write("-" * 80 + "\n")
        f.write("Input Layer:\n")
        f.write(f"  - Linear: {num_features} -> 256\n")
        f.write("  - BatchNorm1d(256)\n")
        f.write("  - ReLU + Dropout(0.5)\n\n")
        
        f.write("ResNeXt Blocks (5 blocks):\n")
        f.write("  - Block 1: 256 -> 512 (cardinality=32)\n")
        f.write("  - Block 2: 512 -> 512 (cardinality=32)\n")
        f.write("  - Block 3: 512 -> 1024 (cardinality=32)\n")
        f.write("  - Block 4: 1024 -> 1024 (cardinality=32)\n")
        f.write("  - Block 5: 1024 -> 2048 (cardinality=32)\n\n")
        
        f.write("Classifier Head:\n")
        f.write("  - Dropout(0.5)\n")
        f.write("  - Linear: 2048 -> 1024\n")
        f.write("  - ReLU + Dropout(0.5)\n")
        f.write("  - Linear: 1024 -> 512\n")
        f.write("  - ReLU + Dropout(0.25)\n")
        f.write(f"  - Linear: 512 -> {num_classes}\n\n")
        
        f.write("-" * 80 + "\n")
        f.write("TRAINING CONFIGURATION\n")
        f.write("-" * 80 + "\n")
        f.write("Optimizer: AdamW (lr=0.001, weight_decay=0.01)\n")
        f.write("Scheduler: ReduceLROnPlateau (mode=max, factor=0.5, patience=5)\n")
        f.write("Loss Function: CrossEntropyLoss\n")
        f.write("Epochs: 200 (with early stopping, patience=15)\n")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("RESNEXT50 AVERAGE PERFORMANCE EVALUATION (6-CLASS)")
    print("=" * 80)
    ...
    results_dir = Path("results/resnext50_6class_5run_results")
    ...
    sample_model = ResNeXt50KeypointClassifier(
