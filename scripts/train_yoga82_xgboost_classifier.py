"""
XGBoost Average Performance Evaluation (Unified Script for 6/20/82-Class)
...
Usage:
    python average_train_xgboost_classifier.py --data output_dataset/yoga_poses_dataset_vit_6class.csv
    python average_train_xgboost_classifier.py --data output_dataset/yoga_poses_dataset_vit_20class.csv
    python average_train_xgboost_classifier.py --data output_dataset/yoga_poses_dataset_vit_82vanilla.csv
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='XGBoost Yoga Pose Classifier')
    parser.add_argument('--data', type=str, required=True,
                      help='Path to CSV dataset (e.g., output_dataset/yoga_poses_dataset_vit_6class.csv)')
    parser.add_argument('--epochs', type=int, default=200,
                      help='Maximum number of boosting iterations (default: 200)')
    ...
    print("\n" + "=" * 80)
    print(f"XGBOOST AVERAGE PERFORMANCE EVALUATION ({dataset_type.upper()})")
    print("=" * 80)
    ...
    # Configuration
    data_path = args.data
    results_dir = Path(f"results/xgboost_{dataset_type}_5run_results")
