"""
Phase 3: ResNeXt50 Average Performance Evaluation (20-Class Dataset)
...
- Saves results to resnext50_20class_5run_results/ folder
...
def save_model_summary(results_dir, model, num_features, num_classes):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("RESNEXT50 MODEL ARCHITECTURE SUMMARY (20-CLASS)\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("RESNEXT50 AVERAGE PERFORMANCE EVALUATION (20-CLASS)")
    print("=" * 80)
    ...
    results_dir = Path("results/resnext50_20class_5run_results")
