"""
Phase 3: DenseNet121 Average Performance Evaluation (6-Class Dataset)
...
- Saves results to densenet121_6class_5run_results/ folder
...
def save_model_summary(results_dir, model, num_features, num_classes):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("DENSENET121 MODEL ARCHITECTURE SUMMARY (6-CLASS)\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("DENSENET121 AVERAGE PERFORMANCE EVALUATION (6-CLASS)")
    print("=" * 80)
    ...
    results_dir = Path("results/densenet121_6class_5run_results")
