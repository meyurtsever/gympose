"""
Phase 3: FT-Transformer Average Performance Evaluation (20-Class Dataset)
...
- Saves results to fttransformer_20class_5run_results/ folder
...
def save_model_summary(results_dir, model, num_features, num_classes):
    ...
    with open(summary_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("FT-TRANSFORMER MODEL ARCHITECTURE SUMMARY (20-CLASS)\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("FT-TRANSFORMER AVERAGE PERFORMANCE EVALUATION (20-CLASS)")
    print("=" * 80)
    ...
    results_dir = Path("results/fttransformer_20class_5run_results")
